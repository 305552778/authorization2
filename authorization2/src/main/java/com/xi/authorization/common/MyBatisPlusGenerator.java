package com.xi.authorization.common;
...
public class MyBatisPlusGenerator {
    ...
    /*public static void main(String[] args) {
        ...
        globalConfig.setAuthor("Gong Qiang");
        //同名文件覆盖
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1/office_hall?serverTimezone=UTC");
        ...
        //packageConfig.setModuleName("authorization");
        packageConfig.setParent("com.xi.authorization");
