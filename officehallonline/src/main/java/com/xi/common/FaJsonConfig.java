 ...
 */
@Configuration
public class FaJsonConfig<FastJsonConfig> implements WebMvcConfigurer {

    //@Bean
    //public <FastJsonHttpMessageConverter> HttpMessageConverters fastJsonHttpMessageConverters() {
